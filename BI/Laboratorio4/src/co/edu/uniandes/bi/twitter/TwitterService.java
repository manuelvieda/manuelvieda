/**
 * Clases para el acceso a datos de Twitter
 */
...
public class TwitterService {
	...
	private void verifyLimit() throws DataAccessException, TwitterException {
		...
		if (status.getRemainingHits() <= 0) {
			throw new DataAccessException("Se ha alcanzado la cuota de uso de servicio de Twitter. Intente nuevamente en: "+status.getResetTime());
		}
	}
	 ...
	 * <b>pre: </b> el parámetro queryString no se ha codificado como URL   
	   ...
	   @return tweets
	 */
	public Collection<Tweet> search(String queryString) throws DataAccessException {
		Query query = null;
		...
		// Sólo retorna la primera página
		query.setPage(1);
		try {
		...
		//TODO modificar para que el método acumule los resultados de 10 páginas
	 ...
	 * Busca los tweets que contienen una o más palabras claves del conjunto dado
	   ...
	   @return tweets
	 */
	public Collection<Tweet> searchTweetsWithKeywords(Set<String> keywords, int page) throws DataAccessException {
		Query query = null;
		Collection<Tweet> tweets = null;
	 ...
	 * <b>pre: </b> el parámetro queryString no se ha codificado como URL   
	   ...
	   @return tweets
	 */
	public Collection<Tweet> searchPopularInEnglish(String queryString) throws DataAccessException {
		Query query = null;
		Collection<Tweet> tweets = null;
	...
	/**
	 * Obtiene la información del usuario dado su login
	 * @param userLogin
	 * @return user
	 */
	public User lookupUser(String userLogin) {
		User user = null;
		// TODO completar
		return user;
	}
