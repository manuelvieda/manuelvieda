...
public class TwitterAsyncAdapter {
	...
	/**
	 * Registra una instancia que va a escuchar los resultados de 
	...
	public void search(String queryString, int page) {
		//TODO: crear el objeto Query
		
		//TODO: establecer el número de mensajes por página
		
		//TODO: establece la página
		
		// TODO:filtra por mensajes en Inglés
		
		// TODO:realiza la consulta
	 ...
	 * Busca los tweets que contienen una o más palabras claves del conjunto dado
	   ...
	   @see <a href="http://dev.twitter.com/doc/get/search">GET search</a>
	   @see <a href="http://search.twitter.com/operators">Twitter API / Search Operators</a>
	 * <b>pre: </b> Se ha registrado un listener a través del método TwitterAsyncAdapter#addTwitterListener  
	 */
